...
Read [reference.md](reference.md) for the overview — what validate-pr-review-app is, how it
works end to end (with a sequence diagram), supported platforms, why it exists, and pointers to
the sibling skills for each detailed topic.
