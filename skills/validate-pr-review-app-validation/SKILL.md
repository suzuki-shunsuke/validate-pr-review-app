...
description: |
  Explain the validation rules and behavior of validate-pr-review-app — the approval rules, why a
  ...
  requirements or merge validation behavior, this skill applies. For a high-level overview of
  what the app is and how it works, use the overview skill; for changing settings such as
  trusted_apps, use the configuration skill.
---

Read the file that matches the task:

- Read [reference.md](reference.md) first — the validation rules (when 1 vs 2 approvals are required), merge queue support, and CSM Actions for automatic code fixes and approvals without extra reviews.
